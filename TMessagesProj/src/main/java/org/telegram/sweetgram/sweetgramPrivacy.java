 ...
 */
public class SweetgramPrivacy {

    public static boolean streamer() {
        return SweetgramConfig.streamerMode();
    }
    ...
    public static String phone(String formatted, long userId) {
        ...
        if (!own(userId) && !SweetgramConfig.streamerHidesOthers()) {
            return formatted;
        }
    ...
    public static String username(String name, long userId) {
        ...
        if (!own(userId) || !SweetgramConfig.streamerHidesUsername()) {
            return name;
        }
        return mask(name);
    }
