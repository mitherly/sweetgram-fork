...
/**
 * Фильтр Zalgo и краш-символов в никах и тексте сообщений.
 */
public abstract class SweetgramZalgo {
    ...
    public static boolean canFilter(CharSequence charSequence) {
        return (!SweetgramConfig.filterZalgo() || TextUtils.isEmpty(charSequence) || findReplacementRanges(charSequence) == null) ? false : true;
    }
    ...
    public static String filter(String str) {
        return (!SweetgramConfig.filterZalgo() || TextUtils.isEmpty(str)) ? str : filterEnabled(str);
    }
