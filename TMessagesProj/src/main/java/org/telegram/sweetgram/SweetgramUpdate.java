...
public class SweetgramUpdate {
    ...
    private static final String PREFS = "sweetgram_update";
    ...
    public static final class Info {
        ...
        public String about() {
            return SweetgramRemote.localized(json, "about", "");
        }
    }
    ...
    public static void check(Runnable done) {
        ...
        SweetgramRemote.fetch(FILE, CACHE_KEY, text -> {
            if (done != null) {
                done.run();
            }
        });
    ...
    public static void schedule() {
        ...
        final int minutes = SweetgramConfig.updateIntervalMinutes();
        if (minutes <= 0) {
            return;
        }
        ...
        scheduled = new Runnable() {
            ...
            public void run() {
                ...
                if (SweetgramConfig.updateIntervalMinutes() <= 0) {
                    scheduled = null;
                    return;
                }
    ...
    public static Info available() {
        final String text = SweetgramRemote.cached(CACHE_KEY);
        if (text == null) {
            return null;
        }
        try {
            ...
            return newer(version, SweetgramConfig.APP_VERSION) ? new Info(version, apk, json) : null;
    ...
    private static File file() {
        ...
        return new File(directory, "sweetgram_update.apk");
    }
