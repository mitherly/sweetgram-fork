...
public class SweetgramSpans {
    ...
    public static Object create(int kind, int value) {
        switch (kind) {
            case SweetgramMarkup.KIND_SIZE:
                return new Size(value);
            case SweetgramMarkup.KIND_DIM:
                return new Dim(value);
            case SweetgramMarkup.KIND_RAINBOW:
                return new Rainbow(value);
            case SweetgramMarkup.KIND_OUTLINE:
    ...
    /** Размер. Границы шкалы держит {@link SweetgramMarkup#sizeOf(int)}. */
    public static class Size extends Base {
        ...
        @Override
        public int kind() {
            return SweetgramMarkup.KIND_SIZE;
        }
        ...
        private void resize(TextPaint paint) {
            paint.setTextSize(paint.getTextSize() * SweetgramMarkup.sizeOf(value));
        }
    }
    ...
    public static class Dim extends Base {
        ...
        @Override
        public int kind() {
            return SweetgramMarkup.KIND_DIM;
        }
    ...
    public static class Rainbow extends Base {
        ...
        @Override
        public int kind() {
            return SweetgramMarkup.KIND_RAINBOW;
        }
    ...
    public static class Outline extends ReplacementSpan {
        ...
        public int kind() {
            return SweetgramMarkup.KIND_OUTLINE;
        }
    ...
    public static class ButtonMark extends Base {
        ...
        @Override
        public int kind() {
            return SweetgramMarkup.KIND_BUTTON;
        }
        ...
        @Override
        public byte[] payload() {
            return SweetgramMarkup.bytesOf(url);
        }
