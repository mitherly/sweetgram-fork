...
/**
 * Иконка Sweetgram в объёме: тот же скруглённый квадрат с самолётиком, только
 ...
 */
public class SweetgramPlane3D extends View {
    ...
    public SweetgramPlane3D(Context context) {
        this(context, FIELD);
    }
     ...
     */
    public SweetgramPlane3D(Context context, int color) {
        super(context);
        field = color;
        side = darker(color);
