...
import org.telegram.ui.SweetgramSettingsActivity;
import org.telegram.ui.SweetgramPluginsActivity;
...
public class DrawerMenuView extends ScrollView {
    ...
    public void rebuildMenu(int currentAccount, BaseFragment fragment) {
        ...
        addItem(R.drawable.settings_features, "Sweetgram", () -> {
            fragment.presentFragment(new SweetgramSettingsActivity());
        });
        addItem(R.drawable.settings_devices, LocaleController.getString(R.string.SweetgramPlugins), () -> {
            fragment.presentFragment(new SweetgramPluginsActivity());
        });
