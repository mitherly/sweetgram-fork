 ...
 */
public abstract class MargeletZalgo {
    ...
    public static boolean canFilter(CharSequence charSequence) {
        return (!MargeletConfig.filterZalgo() || TextUtils.isEmpty(charSequence) || findReplacementRanges(charSequence) == null) ? false : true;
    }
    ...
    public static String filter(String str) {
        return (!MargeletConfig.filterZalgo() || TextUtils.isEmpty(str)) ? str : filterEnabled(str);
    }
