 ...
 */
public class SweetgramPluginConsoleActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.SweetgramPluginConsole));
    ...
    public boolean onFragmentCreate() {
        SweetgramPluginHost.addListener(listener);
        return super.onFragmentCreate();
    }

    @Override
    public void onFragmentDestroy() {
        SweetgramPluginHost.removeListener(listener);
    ...
    private void refresh() {
        ...
        final List<SweetgramPluginHost.Line> lines = SweetgramPluginHost.console();
        if (lines.isEmpty()) {
            text.setText(LocaleController.getString(R.string.SweetgramPluginConsoleEmpty));
            return;
        }
        final SpannableStringBuilder out = new SpannableStringBuilder();
        for (SweetgramPluginHost.Line line : lines) {
