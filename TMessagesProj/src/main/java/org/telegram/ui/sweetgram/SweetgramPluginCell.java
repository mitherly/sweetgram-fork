 ...
 */
public class SweetgramPluginCell extends FrameLayout implements Theme.Colorable {
    ...
    public SweetgramPluginCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        super(context);
    ...
    public static class Factory extends UItem.UItemFactory<SweetgramPluginCell> {
        static { setup(new Factory()); }

        @Override
        public SweetgramPluginCell createView(Context context, RecyclerListView listView, int currentAccount,
                                             int classGuid, Theme.ResourcesProvider resourcesProvider) {
            return new SweetgramPluginCell(context, resourcesProvider);
        }

        @Override
        public void bindView(View view, UItem item, boolean divider, UniversalAdapter adapter,
                             UniversalRecyclerView listView) {
            ((SweetgramPluginCell) view).set((SweetgramPlugins.Plugin) item.object, item.checked, false);
        }

        public static UItem of(int id, SweetgramPlugins.Plugin plugin, boolean checked) {
