...
/**
 * Панель форка: управление верификацией пользователей.
...
public class SweetgramAdminActivity extends BaseFragment {
    ...
    public android.view.View createView(Context context) {
        ...
        View manageView = buildManageView(context);
        ...
        root.addView(manageScroll, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT));
